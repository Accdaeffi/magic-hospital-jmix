...
@StudioAction(target = "io.jmix.ui.component.ListComponent", description = "Accept prayer")
@ActionType("acceptPrayer")
public class AcceptPrayerAction<E extends Prayer> extends ItemTrackingAction {
    ...
    public AcceptPrayerAction(String id) {
        super(id);
        setCaption("Accept prayer");
    }
    ...
    public void actionPerform(Component component) {
        ...
        selectedPrayer.setPrayerStatus(PrayerStatus.ACCEPTED);
